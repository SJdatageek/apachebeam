...
public class MapElementsSimpleFunction {
	...
	public static void main(String[] args) {
		...
		PCollection<String> pUserList= p.apply(TextIO.read().from(
				"/Users/salonijain/Documents/apachebeam/apachebeam/apachebeam/src/main/resources/user.csv"));
		...
		pOutput.apply(TextIO.write().to(
				"/Users/salonijain/Documents/apachebeam/apachebeam/apachebeam/target/output/user_output.csv")
